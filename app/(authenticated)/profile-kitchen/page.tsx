...
const ProfileKitchen = () => {
  ...
  console.log(dataKitchen?.data?.logos, "ini data kitchen");
          ...
          <div className="text-justify bg-white py-7 px-10 rounded w-[920px]">
            <div className="flex">
              ...
              <Tag color="green" className="mt-2  ml-10 text-xl h-8">
                {dataKitchen?.data?.users?.status}
              </Tag>
            </div>
            <div className="flex text-xl">
              <p className=" font-semibold mr-12">No WhatsApp</p>
              <p className="mr-2"></p>
              <p>{dataKitchen?.data?.users.phoneNumber}</p>
            </div>
            <div className="flex text-xl">
              <p className=" font-semibold mr-28">Alamat</p>
              <p className="mr-2"></p>
              <p>
            ...
            <div className="flex text-xl">
              <p className=" font-semibold mr-24">Legalitas</p>
              <p className="mr-2"></p>
              <p className="text-xl">
                <FullRoundedButton
            ...
            <div className="flex text-xl">
              <p className=" font-semibold mr-16">Jumlah Chef</p>
              <p className="mr-2"></p>
              <p>{dataKitchen?.data?.numberOfChefs} orang</p>
            </div>
            <div className="flex text-xl">
              <p className=" font-semibold mr-24">Deskripsi</p>
              <p className="mr-2"></p>
              <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Debitis minima iure nisi architecto odio ex consequuntur
